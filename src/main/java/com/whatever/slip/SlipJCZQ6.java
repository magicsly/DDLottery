...
public class SlipJCZQ6 implements ISlipJCZQ {
	...
	static {
		...
		mapSelect.put(Select.JQS0, new OmrPoint(0,9));
		mapSelect.put(Select.JQS1, new OmrPoint(1,9));
		mapSelect.put(Select.JQS2, new OmrPoint(2,9));
		mapSelect.put(Select.JQS3, new OmrPoint(3,9));
		
		mapSelect.put(Select.JQS4, new OmrPoint(0,10));
		mapSelect.put(Select.JQS5, new OmrPoint(1,10));
		mapSelect.put(Select.JQS6, new OmrPoint(2,10));
		mapSelect.put(Select.JQS7, new OmrPoint(3,10));
		
		mapPass.put(Pass.PASS4_1, new OmrPoint(0,1));
		mapPass.put(Pass.PASS4_4, new OmrPoint(1,1));
		mapPass.put(Pass.PASS4_5, new OmrPoint(2,1));
		mapPass.put(Pass.PASS4_6, new OmrPoint(3,1));
		mapPass.put(Pass.PASS4_11, new OmrPoint(4,1));
		
		mapPass.put(Pass.PASS5_1, new OmrPoint(0,2));
		mapPass.put(Pass.PASS5_5, new OmrPoint(1,2));
		mapPass.put(Pass.PASS5_6, new OmrPoint(2,2));
		mapPass.put(Pass.PASS5_10, new OmrPoint(3,2));
		mapPass.put(Pass.PASS5_16, new OmrPoint(4,2));
		mapPass.put(Pass.PASS5_20, new OmrPoint(5,2));
		mapPass.put(Pass.PASS5_26, new OmrPoint(6,2));
		
		mapPass.put(Pass.PASS6_1, new OmrPoint(0,3));
		mapPass.put(Pass.PASS6_6, new OmrPoint(1,3));
		mapPass.put(Pass.PASS6_7, new OmrPoint(2,3));
		mapPass.put(Pass.PASS6_15, new OmrPoint(3,3));
		mapPass.put(Pass.PASS6_20, new OmrPoint(4,3));
		mapPass.put(Pass.PASS6_22, new OmrPoint(5,3));
		mapPass.put(Pass.PASS6_35, new OmrPoint(6,3));
		mapPass.put(Pass.PASS6_42, new OmrPoint(7,3));
	...
	public SlipJCZQ6() {
		...
		oaMatchList.add(new OmrArea(4,11,1,3));
		oaMatchList.add(new OmrArea(4,11,5,3));
		oaMatchList.add(new OmrArea(4,11,9,3));
		oaMatchList.add(new OmrArea(4,11,1,14));
		oaMatchList.add(new OmrArea(4,11,5,14));
		oaMatchList.add(new OmrArea(4,11,9,14));
